...
set c=cl
set oooinst=C:\Program Files\Go-OO 2.4
set ooosdk=C:\Program Files\OpenOffice.org_2.4_SDK
...
set srcfiles=..\source\numeric\baselinesearch.cxx ..\source\numeric\bisectionsearch.cxx ..\source\numeric\cellfuncobj.cxx ..\source\numeric\cycliccoordinate.cxx ..\source\numeric\diff.cxx ..\source\numeric\exception.cxx ..\source\numeric\funcobj.cxx ..\source\numeric\hookejeeves.cxx ..\source\numeric\lpbase.cxx ..\source\numeric\lpmodel.cxx ..\source\numeric\lpsolve.cxx ..\source\numeric\matrix.cxx ..\source\numeric\nlpbase.cxx ..\source\numeric\nlpmodel.cxx ..\source\numeric\penalty.cxx ..\source\numeric\polyeqnsolver.cxx ..\source\numeric\quadfitlinesearch.cxx ..\source\numeric\quasinewton.cxx ..\source\numeric\rosenbrock.cxx ..\source\service\service.cxx ..\source\tool\global.cxx ..\source\tool\timer.cxx ..\source\ui\basedlg.cxx ..\source\ui\baselistener.cxx ..\source\ui\dialog.cxx ..\source\ui\listener.cxx ..\source\ui\lpbuilder.cxx ..\source\ui\msgdlg.cxx ..\source\ui\nlpbuilder.cxx ..\source\ui\option.cxx ..\source\ui\optiondlg.cxx ..\source\ui\resmgr.cxx ..\source\ui\solvemodel.cxx ..\source\ui\unoglobal.cxx ..\source\ui\unohelper.cxx ..\source\ui\xcalc.cxx 

set sdklibs="%sdklib%\isal.lib" "%sdklib%\icppu.lib" "%sdklib%\icppuhelper.lib"

rem cppumaker -BUCR "%oooinst%\program\types.rdb" -O.\obj
...
zip -r scsolver.uno.oxt Addons.xcu ProtocolHandler.xcu scsolver.uno.dll scsolver.uno.rdb description.xml license.txt META-INF translation